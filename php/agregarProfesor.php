...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <form class="agregarUsuario" action="procesarAgregarProfesor.php" method="POST">
      ...
      <div class="agregarUsuario-grupo">
        ...
        <div class="agregar-usuario-fecha-profesor">
          ...
          <input type="text" id="fecha"  name="fecha" placeholder="Fecha de Nacimiento*">
        </div>
        ...
        <div class="agregar-usuario-botones">
          <p>¿Deseas <a href="profesor.php">Regresar</a>?</p>
