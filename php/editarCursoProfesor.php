...
<html lang="en" dir="ltr">
  <head>
    ...
    <title>Profe/Curso/Editar</title>
  </head>
  <body>
    <?php
    $id = $_GET['id'];
    include("../conexionbd/conectar.php");
    $consulta="SELECT a.id_asistencia,e.nombre,e.apellido,lunes,martes,miercoles,jueves,viernes,c.nombre_curso FROM asistencia a INNER JOIN curso c ON  a.id_curso = c.id_curso INNER JOIN estudiante e ON a.id_estudiante = e.id_estudiante WHERE a.id_asistencia='$id'";
    $sql = mysqli_query($conexionbd,$consulta);
    $mostrar =mysqli_fetch_assoc($sql);
    ?>

    <form class="agregarUsuario" action="procesarActualizarCursoProfesor.php" method="POST">
      <div class="agregarUsuario-titulo">
          <h3>Editar Asistencia</h3>
              ...
              <div class="agregar-usuario-botones-4">
                <p>¿Deseas <a href="cursoProfesor.php">Regresar</a>?</p>
