...
<html lang="en" dir="ltr">
  ...
  <body>
    <form class="editarUsuario" action="procesarActualizarEstudiante.php" method="post">
      ...
      <div class="agregarUsuario-grupo">
              ...
              <div class="editar-usuario-fecha">
                <input type="text" name="f_nacimiento" value="<?php echo $mostrar['f_nacimiento'];?>">
              </div>
        ...
        <div class="agregar-usuario-botones-editar-2">
