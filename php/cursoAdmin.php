  ...
  <body>
    ...
    <header>
      ...
      <main>
        ...
        <form action="cursoAdmin.php" method="POST">
          ...
          <?php while($mostrar=mysqli_fetch_assoc($resultado_curso)){?>
                ...
                <tr class="campos-tabla-asistencia">
                    ...
                    <th><a href="editarCursoAdmin.php?id=<?php echo $mostrar['id_asistencia'];?>">Editar</a></th>
                </tr>
          <?php }?>
            ...
            <div class="agregar-asistencia">
              <p>Agregar asistencia a estudiante <a href="agregrarAsistencia.php">Agregar</a></p>
            </div>
          </main>
          <footer>
