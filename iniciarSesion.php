...
<body>
    <div class="padre">
        ...
        <form action="verificarUsuario.php" class="form" method="POST">
            ...
            <div class="inputs">
            <input type="text"name="usuario"placeholder="usuario" class="inputs-ingresar" pattern="[A-Za-z0-9]+" focus required>
            ...
            <input type="password" name="password" placeholder="password"  class="inputs-ingresar" pattern="[A-Za-z0-9]+" required>
            <input type="submit" value="enviar" class="inputs-enviar">
            </div>
        </form>
        </div>
    </div>
